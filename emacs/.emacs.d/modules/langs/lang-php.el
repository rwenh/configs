...
(use-package lsp-mode
  ...
  :config
  ;; intelephense (npm install -g intelephense) — preferred
  ;; phpactor (composer global require phpactor/phpactor) — free alternative
  (when (boundp 'lsp-intelephense-licence-key)
    ;; Users can set lsp-intelephense-licence-key in their local config
    ;; for premium features. The free tier works without a key.
    nil))
