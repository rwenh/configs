...
;; Applied when apheleia is not active so saves are always formatted.
...
;;;; ── go-ts-mode (FIX #71) ────────────────────────────────────────────────────
;; go-ts-mode is the default in Emacs 29+ when the Go tree-sitter grammar
;; is installed.  All go-mode features are mirrored here.
